...
📥 Data Collection: Sourced cricket match datasets (player stats, match outcomes) from repositories & APIs.

🧹 Data Cleaning: Handled missing values, format issues, and outliers with Pandas.

📊 Exploratory Data Analysis (EDA): Measured batting averages, strike rates, team win rates using SQL + Python.

🎨 Visualization: Created engaging plots (bar charts, heatmaps, trend graphs).
